...
// ── Crate Card ────────────────────────────────────────────────
function CrateCard({ crate, colorIdx, onClick, onPlay, onShuffle, onDelete, onShare, isPlaying }) {
  ...
  return (
    <div className={`lc-card ${isPlaying ? 'lc-card--active' : ''}`}
      ...
      onClick={onClick}
    >
      {/* Full-bleed header with thumbnail collage + name overlaid */}
      ...
      {/* Body — mobile only (desktop name is on image) */}
      ...
      <div className="lc-card-actions" onClick={e => e.stopPropagation()}>
        ...
        <button className="lc-btn-icon" onClick={onShuffle} disabled={!songs.length} title="Shuffle">
        ...
        <button className="lc-btn-icon" onClick={onShare} disabled={!songs.length} title="Share all songs">
